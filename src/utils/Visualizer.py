...
class Visualizer(object):
    ...
    def vis(self, idx, iter, gt_depth, gt_color, c2w_or_camera_tensor, c,
        ...
        #             c2w = torch.cat([c2w, bottom], dim=0) # tensor
        #         else:
        ...
        #         depth_residual = torch.abs(gt_depth_np - depth_np)
        #         depth_residual[gt_depth_np == 0.0] = 0.0
        #         color_residual = torch.abs(gt_color_np - color_np)
        #         color_residual[gt_depth_np == 0.0] = 0.0

        #         fig, axs = plt.subplots(2, 3)
        #         fig.tight_layout()
        #         max_depth = torch.max(gt_depth_np)
                
        #         print("gt_depth_np: ", gt_depth_np.shape)
        #         axs[0, 0].imshow(gt_depth_np.detach().cpu().numpy(), cmap="plasma",
        #                          vmin=0, vmax=max_depth)
        #         axs[0, 0].set_title('Input Depth')
        #         axs[0, 0].set_xticks([])
        #         axs[0, 0].set_yticks([])
        #         print("depth_np: ", depth_np.shape)
        #         axs[0, 1].imshow(depth_np.detach().cpu().numpy(), cmap="plasma",
        #                          vmin=0, vmax=max_depth)
        #         axs[0, 1].set_title('Generated Depth')
        #         axs[0, 1].set_xticks([])
        #         axs[0, 1].set_yticks([])
        #         print("depth_residual:", depth_residual.shape)
        #         axs[0, 2].imshow(depth_residual.detach().cpu().numpy(), cmap="plasma",
        #                          vmin=0, vmax=max_depth)
        #         axs[0, 2].set_title('Depth Residual')
        #         axs[0, 2].set_xticks([])
        #         axs[0, 2].set_yticks([])
        #         gt_color_np = torch.clamp(gt_color_np, 0, 1)
        #         color_np = torch.clamp(color_np, 0, 1)
        #         color_residual = torch.clamp(color_residual, 0, 1)
        #         print("gt_color_np ", gt_color_np.shape)
        #         axs[1, 0].imshow(gt_color_np.detach().cpu().numpy(), cmap="plasma")
        #         axs[1, 0].set_title('Input RGB')
        #         axs[1, 0].set_xticks([])
        #         axs[1, 0].set_yticks([])
        #         print("gt_color_np ", gt_color_np.shape)
        #         axs[1, 1].imshow(color_np.detach().cpu().numpy(), cmap="plasma")
        #         axs[1, 1].set_title('Generated RGB')
        #         axs[1, 1].set_xticks([])
        #         axs[1, 1].set_yticks([])
        #         print("color_residual", color_residual.shape)
        #         axs[1, 2].imshow(color_residual.detach().cpu().numpy(), cmap="plasma")
