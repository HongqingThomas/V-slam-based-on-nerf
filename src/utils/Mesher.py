...
class Mesher(object):
    ...
    def __init__(self, cfg, args, slam, points_batch_size=50000, ray_batch_size=10000):
        """
    ...
    def point_masks(self, input_points, keyframe_dict, estimate_c2w_list,
        ...
        forecast_mask_list = []
        unseen_mask_list = []
        # print("Mesher input_points:", input_points.shape)
    ...
    def get_mesh(self,
        ...
        with torch.no_grad():
            ...
            # points does not need to put into cuda and tensor (in get grid unifrom function)
